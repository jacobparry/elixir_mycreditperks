defmodule Api.Resolvers.UserResolverTest do
  ...
  test "create_user_better_errors/3 mutation can return both data and errors" do
    mutation = """
    mutation ($input1: CreateUserInput!, $input2: CreateUserInput!) {
      newUser1: createUserBetterErrors (input: $input1) {
        username
        password
        email
        age
      }
      newUser2: createUserBetterErrors (input: $input2) {
        username
        password
        email
        age
